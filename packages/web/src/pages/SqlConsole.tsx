        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              <button 
                className="sql-example-btn"
                onClick={() => setSql("WITH disciplines(discipline) AS (\n  SELECT 'CCS' UNION ALL SELECT 'CHS' UNION ALL SELECT 'DOC'\n  UNION ALL SELECT 'ELEC' UNION ALL SELECT 'HSE'\n  UNION ALL SELECT 'HULL' UNION ALL SELECT 'MACH'\n  UNION ALL SELECT 'OUTFIT' UNION ALL SELECT 'PAINT'\n  UNION ALL SELECT 'PIPE' UNION ALL SELECT 'SEC'\n)\nSELECT * FROM disciplines ORDER BY discipline;")}
                style={{ textAlign: 'left', padding: '4px 8px', fontSize: 10, background: '#f8fafc', border: '1px solid var(--nb-border)', borderRadius: 4, cursor: 'pointer', color: '#475569', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}
              >
